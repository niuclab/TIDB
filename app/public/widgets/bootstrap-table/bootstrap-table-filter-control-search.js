    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        filterTemplate: {
            ...
            input: function (that, field, isVisible) {
                return sprintf('<div class="col-md-11"><input type="text" class="form-control %s" style="width: 100%; visibility: %s"></div><div class="col-md-1"><i class="fa fa-question helpIcon" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Search within the results"></i></div>', field, isVisible);
            },
            select: function (that, field, isVisible) {
                return sprintf('<div class="col-md-11"><select class="%s form-control" style="width: 100%; visibility: %s" dir="%s"></select></div><div class="col-md-1"><i class="fa fa-question helpIcon" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Search within the results"></i></div>',
